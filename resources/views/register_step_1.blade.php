...
<div class="join-area">
	...
	<a href="{{ route('common.register') }}" class="btn btn-primary btn-block mb-3">I'm Customer</a>
	<a href="{{ route('common.register-as-owner') }}" class="btn btn-light btn-block mb-3">I'm Salon owner</a>
	<a href="{{ route('common.landing') }}" class="text-light text-center d-block">Back</a>
</div>
@endsection